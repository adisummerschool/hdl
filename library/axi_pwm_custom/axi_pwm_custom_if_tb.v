...
module axi_pwm_custom_if_tb;
  ...
  always @(posedge pwm_clk) begin 
    if(data_channel_1 == 12'hFFF) begin 
      ...
      data_channel_0 <= data_channel_0 + 12'hFF;
      data_channel_1 <= data_channel_1 + 12'hFF;
      data_channel_2 <= data_channel_2 + 12'hFF;
      data_channel_3 <= data_channel_3 + 12'hFF;
      data_channel_4 <= data_channel_4 + 12'hFF;
      data_channel_5 <= data_channel_5 + 12'hFF;
    end else begin
