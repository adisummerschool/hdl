  ...
  always @(posedge pwm_clk or negedge rstn) begin
    if (!rstn) begin
      ...
      if (pulse_period_cnt == 0) begin
        ...
        if ((data_channel_0_reg != 12'd0) &&
            (pulse_period_cnt == data_channel_0_reg)) begin
          pwm_led_0_reg <= 1'b0;
        end

        if ((data_channel_1_reg != 12'd0) &&
            (pulse_period_cnt == data_channel_1_reg)) begin
          pwm_led_1_reg <= 1'b0;
        end

        if ((data_channel_2_reg != 12'd0) &&
            (pulse_period_cnt == data_channel_2_reg)) begin
          pwm_led_2_reg <= 1'b0;
        end

        if ((data_channel_3_reg != 12'd0) &&
            (pulse_period_cnt == data_channel_3_reg)) begin
          pwm_led_3_reg <= 1'b0;
        end

        if ((data_channel_4_reg != 12'd0) &&
            (pulse_period_cnt == data_channel_4_reg)) begin
          pwm_led_4_reg <= 1'b0;
        end

        if ((data_channel_5_reg != 12'd0) &&
            (pulse_period_cnt == data_channel_5_reg)) begin
          pwm_led_5_reg <= 1'b0;
        end
