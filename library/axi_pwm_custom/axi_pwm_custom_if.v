...
// internal registers
  ...
  always @ (posedge pwm_clk) begin
    ...
    pwm_led_0_aux <= (data_channel_0_valid > period_counter || rstn == 1'b0) ? 1'b1 : 1'b0;
    pwm_led_1_aux <= (data_channel_1_valid > period_counter || rstn == 1'b0) ? 1'b1 : 1'b0;
    pwm_led_2_aux <= (data_channel_2_valid > period_counter || rstn == 1'b0) ? 1'b1 : 1'b0;
    pwm_led_3_aux <= (data_channel_3_valid > period_counter || rstn == 1'b0) ? 1'b1 : 1'b0;
    pwm_led_4_aux <= (data_channel_4_valid > period_counter || rstn == 1'b0) ? 1'b1 : 1'b0;
    pwm_led_5_aux <= (data_channel_5_valid > period_counter || rstn == 1'b0) ? 1'b1 : 1'b0;
