...
// up bus interface 
  ...
  up_adc_channel #(
    ...
    .adc_crc_err ('b0),
    .adc_softspan (),
    .adc_data_channel (/*here*/data_channel_0),  // Connect the samples data for CHANNEL 0 
    .up_adc_crc_err (),
    .up_adc_pn_err (),
    .up_adc_pn_oos (),
    .up_adc_or (),
  ...
  up_adc_channel #(
    ...
    .adc_crc_err ('b0),
    .adc_softspan (),
    .adc_data_channel (/*here*/data_channel_1),  // Connect the samples data for CHANNEL 1 
    .up_adc_crc_err (),
    .up_adc_pn_err (),
    .up_adc_pn_oos (),
    .up_adc_or (),
  ...
  up_adc_channel #(
    ...
    .adc_crc_err ('b0),
    .adc_softspan (),
    .adc_data_channel (/*here*/data_channel_2),  // Connect the samples data for CHANNEL 2 
    .up_adc_crc_err (),
    .up_adc_pn_err (),
    .up_adc_pn_oos (),
    .up_adc_or (),
  ...
  up_adc_channel #(
    ...
    .adc_crc_err ('b0),
    .adc_softspan (),
    .adc_data_channel (/*here*/data_channel_3),  // Connect the samples data for CHANNEL 3
    .up_adc_crc_err (),
    .up_adc_pn_err (),
    .up_adc_pn_oos (),
    .up_adc_or (),
  ...
  up_adc_channel #(
    ...
    .adc_crc_err ('b0),
    .adc_softspan (),
    .adc_data_channel (/*here*/data_channel_4),  // Connect the samples data for CHANNEL 4 
    .up_adc_crc_err (),
    .up_adc_pn_err (),
    .up_adc_pn_oos (),
    .up_adc_or (),
  ...
  up_adc_channel #(
    ...
    .adc_crc_err ('b0),
    .adc_softspan (),
    .adc_data_channel (/*here*/data_channel_5),  // Connect the samples data for CHANNEL 5
    .up_adc_crc_err (),
    .up_adc_pn_err (),
    .up_adc_pn_oos (),
    .up_adc_or (),
  ...
  axi_pwm_custom_if i_if_axi_pwm_custom (
    ...
    .pwm_led_0 (pwm_led1_r),
    .pwm_led_1 (pwm_led2_r),
    .pwm_led_2 (pwm_led1_g),
    .pwm_led_3 (pwm_led2_g),
    .pwm_led_4 (pwm_led1_b),
