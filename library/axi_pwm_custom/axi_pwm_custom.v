...
// 1.Create the pwm output signals - here
...
// up bus interface 
  ...
  up_adc_channel #(
    ...
    .adc_crc_err ('b0),
    .adc_softspan (),
    .adc_data_channel (data_channel_0),  // Connect the samples data for CHANNEL 0 -here
    .up_adc_crc_err (),
    .up_adc_pn_err (),
    .up_adc_pn_oos (),
    .up_adc_or (),
  ...
  up_adc_channel #(
    ...
    .adc_crc_err ('b0),
    .adc_softspan (),
    .adc_data_channel (data_channel_1),  // Connect the samples data for CHANNEL 1 -here
    .up_adc_crc_err (),
    .up_adc_pn_err (),
    .up_adc_pn_oos (),
    .up_adc_or (),
  ...
  up_adc_channel #(
    ...
    .adc_crc_err ('b0),
    .adc_softspan (),
    .adc_data_channel (data_channel_2),  // Connect the samples data for CHANNEL 2 -here
    .up_adc_crc_err (),
    .up_adc_pn_err (),
    .up_adc_pn_oos (),
    .up_adc_or (),
  ...
  up_adc_channel #(
    ...
    .adc_crc_err ('b0),
    .adc_softspan (),
    .adc_data_channel (data_channel_3),  // Connect the samples data for CHANNEL 3 -here
    .up_adc_crc_err (),
    .up_adc_pn_err (),
    .up_adc_pn_oos (),
    .up_adc_or (),
  ...
  up_adc_channel #(
    ...
    .adc_crc_err ('b0),
    .adc_softspan (),
    .adc_data_channel (data_channel_4),  // Connect the samples data for CHANNEL 4 - here
    .up_adc_crc_err (),
    .up_adc_pn_err (),
    .up_adc_pn_oos (),
    .up_adc_or (),
  ...
  up_adc_channel #(
    ...
    .adc_crc_err ('b0),
    .adc_softspan (),
    .adc_data_channel (data_channel_5),  // Connect the samples data for CHANNEL 5 -here
    .up_adc_crc_err (),
    .up_adc_pn_err (),
    .up_adc_pn_oos (),
    .up_adc_or (),
  ...
  // Add the interface module and connect it to the samples data and output ports - here
