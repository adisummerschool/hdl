...
set_property -dict { PACKAGE_PIN Y19  IOSTANDARD LVCMOS33 } [get_ports { adc_spi_sdo }]; #IO_L17N_T2_34 Sch=ja_n[1]		     
set_property -dict { PACKAGE_PIN Y16  IOSTANDARD LVCMOS33 } [get_ports { adc_spi_sdi }]; #IO_L7P_T1_34 Sch=ja_p[2]              
...
set_property -dict { PACKAGE_PIN W14  IOSTANDARD LVCMOS33  } [get_ports { sniff_spi_cs }]; #IO_L8P_T1_34 Sch=jb_p[1]                  
set_property -dict { PACKAGE_PIN Y14  IOSTANDARD LVCMOS33  } [get_ports { sniff_spi_sdo}]; #IO_L8N_T1_34 Sch=jb_n[1]				 
set_property -dict { PACKAGE_PIN T11  IOSTANDARD LVCMOS33  } [get_ports { sniff_spi_sdi }]; #IO_L1P_T0_34 Sch=jb_p[2]                  
set_property -dict { PACKAGE_PIN T10  IOSTANDARD LVCMOS33  } [get_ports { sniff_spi_clk }]; #IO_L1N_T0_34 Sch=jb_n[2]             
