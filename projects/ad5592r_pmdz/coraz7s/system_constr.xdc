...
set_property -dict { PACKAGE_PIN Y18  IOSTANDARD LVCMOS33 } [get_ports { spi_adc_ss }]; #IO_L17P_T2_34 Sch=ja_p[1]   			 
...
set_property -dict { PACKAGE_PIN W14  IOSTANDARD LVCMOS33  } [get_ports { sniff_adc_ss }]; #IO_L8P_T1_34 Sch=jb_p[1]                  
set_property -dict { PACKAGE_PIN Y14  IOSTANDARD LVCMOS33  } [get_ports { sniff_adc_mosi }]; #IO_L8N_T1_34 Sch=jb_n[1]				 
set_property -dict { PACKAGE_PIN T11  IOSTANDARD LVCMOS33  } [get_ports { sniff_adc_miso }]; #IO_L1P_T0_34 Sch=jb_p[2]                  
set_property -dict { PACKAGE_PIN T10  IOSTANDARD LVCMOS33  } [get_ports { sniff_adc_sck }]; #IO_L1N_T0_34 Sch=jb_n[2]             
