...
set_property -dict { PACKAGE_PIN W14  IOSTANDARD LVCMOS33  } [get_ports { sniff_spi_csn }]; #IO_L8P_T1_34 Sch=jb_p[1]                  
set_property -dict { PACKAGE_PIN Y14  IOSTANDARD LVCMOS33  } [get_ports { sniff_spi_mosi }]; #IO_L8N_T1_34 Sch=jb_n[1]				 
set_property -dict { PACKAGE_PIN T11  IOSTANDARD LVCMOS33  } [get_ports { sniff_spi_miso }]; #IO_L1P_T0_34 Sch=jb_p[2]                  
