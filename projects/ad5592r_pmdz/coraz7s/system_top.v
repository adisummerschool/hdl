...
// 3. Declare the PWM wires that controls the LED's
  ...
  wire            pwm_led_0_r; //led[0]
  wire            pwm_led_0_g; //led[1]
  wire            pwm_led_0_b; //led[2]
  wire            pwm_led_1_r; //led[3]
  wire            pwm_led_1_g; //led[4]
  wire            pwm_led_1_b; //led[5]
...
// 6. Clone the ADC SPI port to the sniffing ports 
  ...
  assign snf_cs     =   adc_cs;
  assign snf_sclk   =   adc_sclk;
  assign snf_sdi    =   adc_sdi;
  assign snf_sdo    =   adc_sdo;
  ...
  system_wrapper i_system_wrapper (
    ...
    .spi0_csn_2_o (),
    .spi0_csn_i (1'b1),
    .spi0_sdi_i (adc_sdi),   // 5. Connect here the SPI MISO
    .spi0_sdo_i (),
    .spi0_sdo_o (adc_sdo),   // 5. Connect here the SPI MOSI
    .spi1_clk_i (1'b0),
    .spi1_clk_o (),
    .spi1_csn_0_o (),
    .spi1_csn_1_o (),
