...
// 4. Add SPI ports for both ADC PMOD connector and scopy PMOD connector 
  output cs,
  output sclk,
  output mosi,
  input miso,
...
// 6. Clone the ADC SPI port to the scopy ports 

  assign scopy_cs=cs;
  assign scopy_sclk=sclk;
  assign scopy_mosi=mosi;
  assign scopy_miso=miso;
