...
// 2. Connect the PWM wires to the input port of the ad_iobuf
    .dio_i ({
            pwm_led2_g,       // led[5] = LED1_G
            pwm_led2_r,       // led[4] = LED1_R
            pwm_led2_b,       // led[3] = LED1_B
            pwm_led1_g,       // led[2] = LED0_G
            pwm_led1_r,       // led[1] = LED0_R
            pwm_led1_b        // led[0] = LED0_B
  }),        
    .dio_o (gpio_i[7:2]),
    .dio_p (led));
...
// 6. Clone the ADC SPI port to the sniffing ports 
  ...
  assign sniff_spi_clk  = adc_spi_clk;
  assign sniff_spi_csn  = adc_spi_csn;
  assign sniff_spi_mosi = adc_spi_mosi;
  assign sniff_spi_miso = adc_spi_miso;
  ...
  system_wrapper i_system_wrapper (
    ...
    .spi0_csn_0_o (adc_spi_csn),   // 5. Connect here the SPI CS
    .spi0_csn_1_o (),
    .spi0_csn_2_o (),
    .spi0_csn_i (1'b1),
