...
// 4. Add SPI ports for both ADC PMOD connector and sniffing PMOD connector 
  ...
  output          sniffing_spi_clk,
  output          sniffing_spi_cs,
  output          sniffing_spi_miso,
  output          sniffing_spi_mosi
);
...
// 6. Clone the ADC SPI port to the sniffing ports 
  ...
  assign sniffing_spi_clk = spi_clk;
  assign sniffing_spi_cs = spi_cs;
  assign sniffing_spi_miso = spi_miso;
  assign sniffing_spi_mosi = spi_mosi;
