...
// 4. Add SPI ports for both ADC PMOD connector and sniffing PMOD connector 
  ...
  output          snif_spi_clk,
  output          snif_spi_cs,
  output          snif_spi_mosi,
  output          snif_spi_miso
);
...
// 6. Clone the ADC SPI port to the sniffing ports 
  ...
  assign adc_spi_clk = snif_spi_clk;
  assign adc_spi_cs = snif_spi_cs;
  assign adc_spi_mosi = snif_spi_mosi;
  assign adc_spi_miso = snif_spi_miso;
