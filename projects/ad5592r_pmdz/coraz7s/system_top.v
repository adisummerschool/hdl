...
// 3. Declare the PWM wires that controls the LED's
  ...
  wire pwm_led_0_r, pwm_led_0_g, pwm_led_0_b, pwm_led_1_r, pwm_led_1_g, pwm_led_1_b;
...
// 6. Clone the ADC SPI port to the sniffing ports 
  ...
  /*here*/
  assign sniffing_sclk = sclk;
  assign sniffing_cs = cs;
  assign sniffing_mosi = mosi;
  assign sniffing_miso = miso;
  ...
  system_wrapper i_system_wrapper (
    ...
    .spi0_clk_i (),
    .spi0_clk_o (sclk),   // 5. Connect here the SPI CLK
    .spi0_csn_0_o (cs),   // 5. Connect here the SPI CS
    .spi0_csn_1_o (),
    .spi0_csn_2_o (),
    .spi0_csn_i (1'b1),
    .spi0_sdi_i (miso),   // 5. Connect here the SPI MISO
    .spi0_sdo_i (),
    .spi0_sdo_o (mosi),   // 5. Connect here the SPI MOSI
    .spi1_clk_i (1'b0),
    .spi1_clk_o (),
    .spi1_csn_0_o (),
    .spi1_csn_1_o (),
