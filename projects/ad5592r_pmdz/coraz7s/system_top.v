...
// 4. Add SPI ports for both ADC PMOD connector and scopy PMOD connector 
  ...
  output          scopy_adc_spi_sclk,
  output          scopy_adc_spi_csn,
...
// 6. Clone the ADC SPI port to the scopy ports 
  ...
  assign scopy_adc_spi_sclk = adc_spi_sclk;
  assign scopy_adc_spi_csn  = adc_spi_csn;
  ...
  system_wrapper i_system_wrapper (
    ...
    .spi0_clk_i (),
    .spi0_clk_o (adc_spi_sclk),   // 5. Connect here the SPI CLK
