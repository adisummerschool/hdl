...
// 4. Add SPI ports for both ADC PMOD connector and sniffing PMOD connector 
  output          cs_pmod_adc,
  output          sclk_pmod_adc,
  output          mosi_pmod_adc,
  input           miso_pmod_adc,

  output          cs_pmod_sniff,
  output          sclk_pmod_sniff,
  output          mosi_pmod_sniff,
  output          miso_pmod_sniff
);
...
// 6. Clone the ADC SPI port to the sniffing ports 
  ...
  assign cs_pmod_sniff = cs_pmod_adc;
  assign sclk_pmod_sniff = sclk_pmod_adc;
  assign mosi_pmod_sniff = mosi_pmod_adc;
  assign miso_pmod_sniff = miso_pmod_adc;
  ...
  system_wrapper i_system_wrapper (
    ...
    .spi0_clk_i (),
    .spi0_clk_o (sclk_pmod_adc),   // 5. Connect here the SPI CLK
    .spi0_csn_0_o (cs_pmod_adc),   // 5. Connect here the SPI CS
    .spi0_csn_1_o (),
    .spi0_csn_2_o (),
    .spi0_csn_i (1'b1),
    .spi0_sdi_i (miso_pmod_adc),   // 5. Connect here the SPI MISO
    .spi0_sdo_i (),
    .spi0_sdo_o (mosi_pmod_adc),   // 5. Connect here the SPI MOSI
    .spi1_clk_i (1'b0),
    .spi1_clk_o (),
    .spi1_csn_0_o (),
    .spi1_csn_1_o (),
