...
// 4. Add SPI ports for both ADC PMOD connector and sniffing PMOD connector 
 ...
 output adc_spi_cs,
  ...
  output sniff_spi_cs,
  output sniff_spi_sdi,
  output sniff_spi_sdo
);
...
// 6. Clone the ADC SPI port to the sniffing ports 
  ...
  assign adc_spi_clk=sniff_spi_clk;
  assign adc_spi_cs=sniff_spi_cs;
  assign adc_spi_sdi=sniff_spi_sdi;
  assign adc_spi_sdo=sniff_spi_sdo;
  ...
  system_wrapper i_system_wrapper (
    ...
    .spi0_csn_2_o (),
    .spi0_csn_i (1'b1),
    .spi0_sdi_i (adc_spi_sdi),   // 5. Connect here the SPI MISO
    .spi0_sdo_i (),
    .spi0_sdo_o (adc_spi_sdo),   // 5. Connect here the SPI MOSI
    .spi1_clk_i (1'b0),
    .spi1_clk_o (),
    .spi1_csn_0_o (),
    .spi1_csn_1_o (),
