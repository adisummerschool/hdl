...
// 4. Add SPI ports for both ADC PMOD connector and sniffing PMOD connector 
  ...
  output sniffing_clk_o,
  output sniffing_csn_0_o,
  output sniffing_sdi_i,
  output sniffing_sdo_o
);
...
// 6. Clone the ADC SPI port to the sniffing ports 
  ...
  assign sniffing_clk_o = spi0_clk_o;
  assign sniffing_csn_0_o = spi0_csn_0_o;
  assign sniffing_sdi_i = spi0_sdi_i;
  assign sniffing_sdo_o = spi0_sdo_o;
