...
# 3. connect the axi_pwm_custom IP to the block design ports using ad_connect command
  ...
  ad_connect axi_pwm_custom_led/pwm_0 pwm_led_0_r
  ad_connect axi_pwm_custom_led/pwm_1 pwm_led_0_g
  ad_connect axi_pwm_custom_led/pwm_2 pwm_led_0_b
  ad_connect axi_pwm_custom_led/pwm_3 pwm_led_1_r
  ad_connect axi_pwm_custom_led/pwm_4 pwm_led_1_g
  ad_connect axi_pwm_custom_led/pwm_5 pwm_led_1_b
