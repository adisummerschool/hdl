...
#    the axi_pwm_custom IP (defined in library/axi_pwm_custom).
    ad_ip_instance axi_pwm_custom pwm_custom 

# 3. Connect each top-level port to the corresponding output pin
#    of the axi_pwm_custom IP.

    ad_connect pwm_custom/pwm_led1_r pwm_led1_r
    ad_connect pwm_custom/pwm_led1_g pwm_led1_g
    ad_connect pwm_custom/pwm_led1_b pwm_led1_b

    ad_connect pwm_custom/pwm_led2_r pwm_led2_r
    ad_connect pwm_custom/pwm_led2_g pwm_led2_g
    ad_connect pwm_custom/pwm_led2_b pwm_led2_b
...
#    This lets software read/write the IP's registers from the PS (processing system).
  ...
  ad_cpu_interconnect 0x44A00000 pwm_custom