...
#    These ports will be mapped to FPGA pins in the constraints file (.xdc).
  ...
  create_bd_port -dir O port_led1_r
  create_bd_port -dir O port_led1_g
  create_bd_port -dir O port_led1_b
  create_bd_port -dir O port_led2_r
  create_bd_port -dir O port_led2_g
  create_bd_port -dir O port_led2_b
...
#    of the axi_pwm_custom IP.
  ...
  ad_connect pwm_ip/pwm_led1_r port_led1_r
  ad_connect pwm_ip/pwm_led1_g port_led1_g
  ad_connect pwm_ip/pwm_led1_b port_led1_b
  ad_connect pwm_ip/pwm_led2_r port_led2_r
  ad_connect pwm_ip/pwm_led2_g port_led2_g
  ad_connect pwm_ip/pwm_led2_b port_led2_b
