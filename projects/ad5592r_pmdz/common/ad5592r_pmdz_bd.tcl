...
#    These ports will be mapped to FPGA pins in the constraints file (.xdc).
  ...
  create_bd_port -dir O pwm_0_r
  create_bd_port -dir O pwm_0_g
  create_bd_port -dir O pwm_0_b

  create_bd_port -dir O pwm_1_r
  create_bd_port -dir O pwm_1_g
  create_bd_port -dir O pwm_1_b
...
#    the axi_pwm_custom IP (defined in library/axi_pwm_custom).
  ...
  ad_ip_instance axi_pwm_custom pwm_super_cool_ip
  

# 3. Connect each top-level port to the corresponding output pin
#    of the axi_pwm_custom IP.

  ad_connect pwm_super_cool_ip/pwm_led1_r pwm_0_r
  ad_connect pwm_super_cool_ip/pwm_led1_g pwm_0_g
  ad_connect pwm_super_cool_ip/pwm_led1_b pwm_0_b

  ad_connect pwm_super_cool_ip/pwm_led2_r pwm_1_r
  ad_connect pwm_super_cool_ip/pwm_led2_g pwm_1_g
  ad_connect pwm_super_cool_ip/pwm_led2_b pwm_1_b
...
#    This lets software read/write the IP's registers from the PS (processing system).
  ...
  ad_cpu_interconnect 0x44A00000 pwm_super_cool_ip