...
#    the axi_pwm_custom IP (defined in library/axi_pwm_custom).
  ...
  ad_ip_instance axi_pwm_custom pwm

# 3. Connect each top-level port to the corresponding output pin
#    of the axi_pwm_custom IP.

  ad_connect pwm/pwm_r_1 led_1_r
  ad_connect pwm/pwm_g_1 led_1_g
  ad_connect pwm/pwm_b_1 led_1_b
  ad_connect pwm/pwm_r_2 led_2_r
  ad_connect pwm/pwm_g_2 led_2_g
  ad_connect pwm/pwm_b_2 led_2_b
...
#    This lets software read/write the IP's registers from the PS (processing system).
  ...
  ad_cpu_interconnect 0x44A00000 pwm