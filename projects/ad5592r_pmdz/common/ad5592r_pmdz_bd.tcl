...
#    the axi_pwm_custom IP (defined in library/axi_pwm_custom).
  ...
  ad_ip_instance axi_pwm_custom axi_pwm_custom_ip

# 3. Connect each top-level port to the corresponding output pin
#    of the axi_pwm_custom IP.

ad_connect axi_pwm_custom_ip/pwm_led1_r pwm_led1_r
ad_connect axi_pwm_custom_ip/pwm_led2_r pwm_led2_r
ad_connect axi_pwm_custom_ip/pwm_led1_g pwm_led1_g
ad_connect axi_pwm_custom_ip/pwm_led2_g pwm_led2_g
ad_connect axi_pwm_custom_ip/pwm_led1_b pwm_led1_b
ad_connect axi_pwm_custom_ip/pwm_led2_b pwm_led2_b
...
ad_cpu_interconnect 0x44A00000 axi_pwm_custom_ip