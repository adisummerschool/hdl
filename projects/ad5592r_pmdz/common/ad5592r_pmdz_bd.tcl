...
#    These ports will be mapped to FPGA pins in the constraints file (.xdc).
  ...
  create_bd_port -dir O port_pwm_led1_r
  create_bd_port -dir O port_pwm_led2_r
  
  create_bd_port -dir O port_pwm_led1_g
  create_bd_port -dir O port_pwm_led2_g

  create_bd_port -dir O port_pwm_led1_b
  create_bd_port -dir O port_pwm_led2_b
...
#    the axi_pwm_custom IP (defined in library/axi_pwm_custom).
  ...
  ad_ip_instance axi_pwm_custom LED_PWM_Sensor
  

# 3. Connect each top-level port to the corresponding output pin
#    of the axi_pwm_custom IP.

  ad_connect LED_PWM_Sensor/pwm_led1_r port_pwm_led1_r
  ad_connect LED_PWM_Sensor/pwm_led2_r port_pwm_led2_r

  ad_connect LED_PWM_Sensor/pwm_led1_g port_pwm_led1_g
  ad_connect LED_PWM_Sensor/pwm_led2_g port_pwm_led2_g

  ad_connect LED_PWM_Sensor/pwm_led1_b port_pwm_led2_b
  ad_connect LED_PWM_Sensor/pwm_led2_b port_pwm_led2_b
...
#    This lets software read/write the IP's registers from the PS (processing system).
  ...
  ad_cpu_interconnect 0x44A00000 LED_PWM_Sensor