...
#    These ports will be mapped to FPGA pins in the constraints file (.xdc).
  ...
  create_bd_port -dir O pwm_led_2_r
  create_bd_port -dir O pwm_led_2_g
  create_bd_port -dir O pwm_led_2_b
...
#    the axi_pwm_custom IP (defined in library/axi_pwm_custom).
  ...
  ad_ip_instance axi_pwm_custom unique_and_efficient_pwm_by_PR

# 3. Connect each top-level port to the corresponding output pin
#    of the axi_pwm_custom IP.

  ad_connect unique_and_efficient_pwm_by_PR/pwm_led_1_r pwm_led_1_r
  ad_connect unique_and_efficient_pwm_by_PR/pwm_led_1_g pwm_led_1_g
  ad_connect unique_and_efficient_pwm_by_PR/pwm_led_1_b pwm_led_1_b
  ad_connect unique_and_efficient_pwm_by_PR/pwm_led_2_r pwm_led_2_r
  ad_connect unique_and_efficient_pwm_by_PR/pwm_led_2_g pwm_led_2_g
  ad_connect unique_and_efficient_pwm_by_PR/pwm_led_2_b pwm_led_2_b
...
#    This lets software read/write the IP's registers from the PS (processing system).
  ...
  ad_cpu_interconnect 0x44A00000 unique_and_efficient_pwm_by_PR