...
# 3. connect the axi_pwm_custom IP to the block design ports using ad_connect command
  ...
  ad_connect axi_pwm_custom_i/pwm_led_0_r pwm_led_0_r 
  ad_connect axi_pwm_custom_i/pwm_led_0_g pwm_led_0_g
  ad_connect axi_pwm_custom_i/pwm_led_0_b pwm_led_0_b

  ad_connect axi_pwm_custom_i/pwm_led_1_r pwm_led_1_r 
  ad_connect axi_pwm_custom_i/pwm_led_1_g pwm_led_1_g
  ad_connect axi_pwm_custom_i/pwm_led_1_b pwm_led_1_b
