...
# 3. connect the axi_pwm_custom IP to the block design ports using ad_connect command
  ...
  ad_connect axi_pwm_custom_i/pwm_led_0 pwm_led_0_r 
  ad_connect axi_pwm_custom_i/pwm_led_1 pwm_led_0_g 
  ad_connect axi_pwm_custom_i/pwm_led_2 pwm_led_0_b 

  ad_connect axi_pwm_custom_i/pwm_led_3 pwm_led_1_r 
  ad_connect axi_pwm_custom_i/pwm_led_4 pwm_led_1_g 
  ad_connect axi_pwm_custom_i/pwm_led_5 pwm_led_1_b 
