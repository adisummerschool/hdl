...
# 2. add axi_pwm_custom IP using ad_ip_instance command
  ...
  ad_ip_instance axi_pwm_custom axi_pwm_2024

# 3. connect the axi_pwm_custom IP to the block design ports using ad_connect command

  ad_connect  axi_pwm_2024/pwm_led_0 pwm_led_0_r
  ad_connect  axi_pwm_2024/pwm_led_1 pwm_led_0_g
  ad_connect  axi_pwm_2024/pwm_led_2 pwm_led_0_b

  ad_connect  axi_pwm_2024/pwm_led_3 pwm_led_1_r
  ad_connect  axi_pwm_2024/pwm_led_4 pwm_led_1_g
  ad_connect  axi_pwm_2024/pwm_led_5 pwm_led_1_b

# 4. connect the axi_pwm_custom IP to the CPU using ad_cpu_interconnect at 0x44a00000

  ad_cpu_interconnect 0x44a00000 axi_pwm_2024