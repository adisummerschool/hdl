...
#    the axi_pwm_custom IP (defined in library/axi_pwm_custom).
  ...
  ad_ip_instance axi_pwm_custom acceleration_pwm

# 3. Connect each top-level port to the corresponding output pin
#    of the axi_pwm_custom IP.

  ad_connect acceleration_pwm/pwm_led1_r led1_r
  ad_connect acceleration_pwm/pwm_led1_g led1_g
  ad_connect acceleration_pwm/pwm_led1_b led1_b

  ad_connect acceleration_pwm/pwm_led2_r led2_r
  ad_connect acceleration_pwm/pwm_led2_g led2_g
  ad_connect acceleration_pwm/pwm_led2_b led2_b
...
#    This lets software read/write the IP's registers from the PS (processing system).
  ...
  ad_cpu_interconnect 0x44A00000 acceleration_pwm