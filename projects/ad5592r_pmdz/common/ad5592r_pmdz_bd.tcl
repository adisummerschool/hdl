...
#    the axi_pwm_custom IP (defined in library/axi_pwm_custom).
  ...
  ad_ip_instance axi_pwm_custom pwm_generator

# 3. Connect each top-level port to the corresponding output pin
#    of the axi_pwm_custom IP.

  ad_connect pwm_generator/pwm_led1_r led_1_r
  ad_connect pwm_generator/pwm_led1_g led_1_g
  ad_connect pwm_generator/pwm_led1_b led_1_b
  ad_connect pwm_generator/pwm_led2_r led_2_r
  ad_connect pwm_generator/pwm_led2_g led_2_g
  ad_connect pwm_generator/pwm_led2_b led_2_b
...
#    This lets software read/write the IP's registers from the PS (processing system).
  ...
  ad_cpu_interconnect 0x44A00000 pwm_generator